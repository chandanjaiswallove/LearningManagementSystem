...
<body>
    ...
    $this->load->view('sections/navbar', [
        'showjoinsnowBtn' => false,
        'showdashboardAccount' => true
    ]);
    ?>    


    <!-- developer Head include -->
    <?php $this->load->view('developer/sections/stHead'); ?>

        <!-- developer stTabs include -->
        <?php
    $this->load->view('developer/stTabs', [
        'showdashboardProfile' => true
    ]);
    ?>
    ...
    <!-- developer footer include -->
    <?php $this->load->view('developer/sections/stFooter'); ?>
