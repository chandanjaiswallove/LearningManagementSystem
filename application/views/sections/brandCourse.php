                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/08.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                            <!-- single swiper style -->
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/09.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                            <!-- single swiper style -->
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/10.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                            <!-- single swiper style -->
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/11.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                            <!-- single swiper style -->
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/12.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                            <!-- single swiper style -->
                            <div class="swiper-slide">
                                <div class="brand-area">
                                    <img src="<?php echo base_url('assets/images/brand/13.svg'); ?>" alt="brand">
                                </div>
                            </div>
                            <!-- single swiper style -->
                        </div>
...
<!-- welcome main showcase course about area start -->
            ...
            <div class="col-xl-6 col-lg-12">
                ...
                <div class="about-one-left-image">
                    <div class="first-order">
                        <div class="thumb-one">
                            <img src="<?php echo base_url('assets/images/about/03.jpg'); ?>" alt="about">
                        ...
                        <div class="thumb-bottom">
                            <img src="<?php echo base_url('assets/images/about/02.jpg'); ?>" alt="about">
                        </div>
                    </div>
                    <div class="second-order">
                        <img src="<?php echo base_url('assets/images/about/01.jpg'); ?>" alt="about">
                ...
                <div class="about-inner-right-one">
                    <div class="what-you-get">
                        ...
                        <div class="single-facilityes">
                            <div class="icon">
                                <img src="<?php echo base_url('assets/images/about/icon/01.png'); ?>" alt="icon-image">
                            </div>
                            <div class="information">
                        ...
                        <div class="single-facilityes">
                            <div class="icon">
                                <img src="<?php echo base_url('assets/images/about/icon/02.png'); ?>" alt="icon-image">
                            </div>
                            <div class="information">
                    ...
                    <div class="author-area">
                        <div class="single-author-and-info">
                            <img src="<?php echo base_url('assets/images/about/01.png'); ?>" alt="about">
                            <div class="information">
                                <a href="#">
...
<!-- welcome main showcase course about area end  -->