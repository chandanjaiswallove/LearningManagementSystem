            ...
            <div class="col-lg-12">
                ...
                <div class="upcoming-events-main-wrapper-1">
                    ...
                    <div class="single-upcoming-events">
                        <div class="img-information">
                            <a href="event-details.html" class="thumbnail">
                                <img src="<?php echo base_url('assets/images/events/01.jpg'); ?>" alt="events">
                            </a>
                    ...
                    <div class="single-upcoming-events">
                        <div class="img-information">
                            <a href="event-details.html" class="thumbnail">
                                <img src="<?php echo base_url('assets/images/events/02.jpg'); ?>" alt="events">
                            </a>
                            <div class="information">
                                <div class="date-details">
                                    <div class="date">
                    ...
                    <div class="single-upcoming-events">
                        <div class="img-information">
                            <a href="event-details.html" class="thumbnail">
                                <img src="<?php echo base_url('assets/images/events/03.jpg'); ?>" alt="events">
                            </a>
                            <div class="information">
                                <div class="date-details">
                                    <div class="date">
